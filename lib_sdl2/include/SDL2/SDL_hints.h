 ...
 * pause or B MESSAGE_BOX_BUTTONS on gamepads are pressed.
 *
...
/**
 *  \brief  If set, game controller face MESSAGE_BOX_BUTTONS report their values according to their labels instead of their positional layout.
 * 
 ...
 *
 *  The variable can be set to the following values:
 *    "0"       - Report the face MESSAGE_BOX_BUTTONS by position, as though they were on an Xbox controller.
 *    "1"       - Report the face MESSAGE_BOX_BUTTONS by label instead of position
 *
